...
struct ParsedItem {
  ...
  var spot: String
  @Guide(description: "분류: 식품/주방용품 등. 단서 없으면 빈 문자열")
  var category: String
  @Guide(description: "태그 0개 이상. 단서 없으면 빈 배열")
  var tags: [String]
}
