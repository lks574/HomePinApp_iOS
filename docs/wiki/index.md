...
- [[Settings]] → iCloud Sync / Share Home Data / Import Shared Home Data — CloudKit private 동기화 설정·계정 상태 확인·가족공유 초대/가져오기
